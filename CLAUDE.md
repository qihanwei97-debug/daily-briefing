...
```
🔔 今日关键（60 秒）
- **【事件核心 ≤25 字】**——关键数据 / 1 句客观背景（默认形态）
- 仅当属"直接法律事件"时（AI 幻觉案、AI 法规、AI 反垄断判决等），dash 后才写法律含义
```

**示例：**
- **Meta 2026 AI Capex $125B 翻倍**——较 2025 年 $52B 提升 140%，资本开支占营收比从 28% 升至 47%
- **Nebraska 首例律师因 AI 幻觉吊销执照**——AI 起草后的引文人工核对的必要性再次显化（直接法律事件，可加视角）
