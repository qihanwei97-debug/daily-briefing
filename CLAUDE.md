...
**用户身份：** 北京汉坤律师事务所**一线律师**（非合伙人 / 非管理层 / 非 IT 部门）；晨报作为**参考材料**分享给所内同事（亦为一线 / 中层律师为主）。

**核心定位：分享，不是下命令。**

写作时永远把读者当作**平级同事**——简报目的是"让同事看到这些 AI 动态对法律工作可能有什么参考价值"，**不是**"告诉同事所内本周必须做 X"。
...
- "本周内所内全员部署"
- "违反者所内合规处罚"
- 任何把作者 / 读者当作管理层、可下命令、可调度全所资源的口吻

**✅ 应该使用的语气：**
- "对做 X 业务的同事可能有参考意义"
- "如果你最近在跟 X 类客户，这条值得留意"
- "可以参考的思路是……"
- "供同行评估"
- "值得关注的是……"
- "感兴趣的同事可以试试……"
- "我自己平时是这样用的……"（写技巧时第一人称视角更自然）
